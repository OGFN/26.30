...
public:
	...
	class FText                                   PatchAvailableInstruction_Default;                 // 0x0090(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   PatchAvailableInstruction_Xbox;                    // 0x00A8(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   PleaseSignIn;                                      // 0x00C0(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   SystemUpdateAvailable;                             // 0x00D8(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   UI;                                                // 0x00F0(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   UnableToComplete;                                  // 0x0108(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   UnableToSignIn;                                    // 0x0120(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   UnableToStartPrivCheck;                            // 0x0138(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   UnexpectedError;                                   // 0x0150(0x0018)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	class FText                                   FailedLoginAgeVerificationIncomplete;              // 0x0210(0x0018)(Edit, NativeAccessSpecifierPublic)
	...
	class FText                                   FailedLoginRequiresCorrectiveAction;               // 0x02B8(0x0018)(Edit, NativeAccessSpecifierPublic)
	...
	class FText                                   FailedStartLogin;                                  // 0x0300(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   FounderChatExitedText;                             // 0x0318(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   FounderChatJoinedText;                             // 0x0330(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   GameDisplayName;                                   // 0x0348(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   GeneralLoginFailure;                               // 0x0360(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   GlobalChatExitedText;                              // 0x0378(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   GlobalChatJoinedText;                              // 0x0390(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   HeadlessAccountFailed;                             // 0x03A8(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   InMatchShutdownTimeWarningText;                    // 0x03C0(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   InvalidUser;                                       // 0x03D8(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoggedOutofMCP;                                    // 0x03F0(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   DisconnectedFromMCP;                               // 0x0408(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoggedOutReturnedToTitle;                          // 0x0420(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoggedOutSwitchedProfile;                          // 0x0438(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoggingIn;                                         // 0x0450(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoggingInConsoleAuth;                              // 0x0468(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoggingOut;                                        // 0x0480(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoginConsole;                                      // 0x0498(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoginFailure;                                      // 0x04B0(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   Logout_Unlink;                                     // 0x04C8(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LogoutCompleted;                                   // 0x04E0(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LostConnection;                                    // 0x04F8(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   LoginStepTimeout;                                  // 0x0510(0x0018)(Edit, NativeAccessSpecifierPublic)
	...
	class FText                                   PremiumAccountName_Sony;                           // 0x05D0(0x0018)(Edit, NativeAccessSpecifierPublic)
	...
	struct FOnlineAccountTexts_FailedLoginConsole FailedLoginConsole;                                // 0x0768(0x0168)(Edit, NativeAccessSpecifierPublic)
