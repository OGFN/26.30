...
{
public:
	uint8                                         Pad_F90[0x20];                                     // 0x0F90(0x0020)(Fixing Size After Last Property [ Dumper-8 ])
	uint8                                         bAutoRegisterWithBudgetAllocator : 1;              // 0x0FB0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoCalculateSignificance : 1;                    // 0x0FB0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bShouldUseActorRenderedFlag : 1;                   // 0x0FB0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_FB1[0xF];                                      // 0x0FB1(0x000F)(Fixing Struct Size After Last Property [ Dumper-8 ])
