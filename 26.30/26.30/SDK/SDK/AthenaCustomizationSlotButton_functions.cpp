...
void UAthenaCustomizationSlotButton_C::OnModifiedStatusUpdated(bool bIsModified)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AthenaCustomizationSlotButton_C", "OnModifiedStatusUpdated");
...
void UAthenaCustomizationSlotButton_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaCustomizationSlotButton_C", "Tick");

	Params::AthenaCustomizationSlotButton_C_Tick Parms{};
