...
void UAthenaItemCustomizationSelector_C::OnPreviewActionButtonUpdated(const class FText& RowDisplayName, class UCommonButtonBase* Button)
{
	static class UFunction* Func = nullptr;
...
void UAthenaItemCustomizationSelector_C::SetFortLockerCategoryVM(class UFortLockerCategoryVM* ViewModel)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaItemCustomizationSelector_C", "SetFortLockerCategoryVM");

	Params::AthenaItemCustomizationSelector_C_SetFortLockerCategoryVM Parms{};
...
class UMaterialInstance* UAthenaItemCustomizationSelector_C::GetCategoryImage(EAthenaCustomizationCategory Index_0) const
{
	static class UFunction* Func = nullptr;
...
class FText UAthenaItemCustomizationSelector_C::GetCategoryName(EAthenaCustomizationCategory Index_0) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaItemCustomizationSelector_C", "GetCategoryName");

	Params::AthenaItemCustomizationSelector_C_GetCategoryName Parms{};
