...
{
public:
	struct FAudioWorldizationSettings             InSettings;                                        // 0x0000(0x0058)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};

// Function AudioWorldization.AudioWorldizationSubsystem.GetAverageTraceDistance
// 0x0004 (0x0004 - 0x0000)
struct AudioWorldizationSubsystem_GetAverageTraceDistance final
{
public:
...
struct AudioWorldizationSubsystem_GetTraceResults final
{
public:
	TArray<struct FAudioSphereTraceResult>        ReturnValue;                                       // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
