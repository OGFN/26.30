...
#include "../NameCollisions.inl"
	...
	namespace Offsets
	{
		constexpr int32 GObjects = 0x0E9125C0;
		constexpr int32 AppendString = 0x00DE9500;
		constexpr int32 GNames = 0x0EAD3AC0;
		constexpr int32 GWorld = 0x0E938D58;
		constexpr int32 ProcessEvent = 0x00D41F5C;
		constexpr int32 ProcessEventIdx = 0x0000004D;
		constexpr int32 Free = 0x00000000;
		constexpr int32 Realloc = 0x03E52BCC;
	}
	...
	{
	public:
		/*  Unlike FMemory::AppendString, FName::ToString allocates memory every time it is used.  */;
		/*  This allocation needs to be freed using UE's FMemory::Free function.                   */;
		/*  Inside of 'FName::GetRawString':                                                       */;
		/*  1. Change "thread_local FAllocatedString TempString(1024);" to "FString TempString;"   */;
		/*  2. Add a "Free" function to FString that calls FMemory::Free(Data);                    */;
		/*  3. Replace "TempString.Clear();" with "TempString.Free();"                             */;
		//static_assert(false, "FName::ToString causes memory-leak. Read comment above!");
	...
	namespace FakeSoftObjectPtr
	{
		...
		{
		public:
			struct FTopLevelAssetPath                     AssetPath;                                         // 0x0000(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	{
	public:
		struct InvalidUseOfTMulticastInlineDelegate   TemplateParamIsNotAFunctionSignature;              // 0x0000(0x000C)(NOT AUTO-GENERATED PROPERTY)
...
{																																										\
	...
	public:
		...
		FName                                         Name;                                              // 0x0020(0x0004)(NOT AUTO-GENERATED PROPERTY)
		int32                                         ObjFlags;                                          // 0x0024(0x0004)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		int32                                         ArrayDim;                                          // 0x0028(0x0004)(NOT AUTO-GENERATED PROPERTY)
		int32                                         ElementSize;                                       // 0x002C(0x0004)(NOT AUTO-GENERATED PROPERTY)
		uint64                                        PropertyFlags;                                     // 0x0030(0x0008)(NOT AUTO-GENERATED PROPERTY)
	...
	{
	public:
		class UEnum* Enum;                                              // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		uint8                                         FieldSize;                                         // 0x0068(0x0001)(NOT AUTO-GENERATED PROPERTY)
		uint8                                         ByteOffset;                                        // 0x0069(0x0001)(NOT AUTO-GENERATED PROPERTY)
		uint8                                         ByteMask;                                          // 0x006A(0x0001)(NOT AUTO-GENERATED PROPERTY)
		uint8                                         FieldMask;                                         // 0x006B(0x0001)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		class UClass* PropertyClass;                                     // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		class UClass* MetaClass;                                         // 0x0070(0x0008)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		class UStruct* Struct;                                            // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		class UFunction* SignatureFunction;                                 // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		class FProperty* KeyProperty;                                       // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	...
	{
	public:
		class FProperty* ElementProperty;                                   // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		class FProperty* UnderlayingProperty;                               // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	...
	{
	public:
		class FFieldClass* FieldClass;                                        // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	};
	...
	{
	public:
		class FProperty* ValueProperty;                                     // 0x0068(0x0008)(NOT AUTO-GENERATED PROPERTY)
	};
