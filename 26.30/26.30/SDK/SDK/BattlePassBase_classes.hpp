...
{
public:
	uint8                                         Pad_400[0x120];                                    // 0x0400(0x0120)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_1658[0xB8];                                    // 0x1658(0x00B8)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_400[0x118];                                    // 0x0400(0x0118)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_304[0x74];                                     // 0x0304(0x0074)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_400[0x1A0];                                    // 0x0400(0x01A0)(Fixing Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_400[0x118];                                    // 0x0400(0x0118)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_580[0x18];                                     // 0x0580(0x0018)(Fixing Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_400[0x68];                                     // 0x0400(0x0068)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_4A8[0x28];                                     // 0x04A8(0x0028)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_400[0x50];                                     // 0x0400(0x0050)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	bool                                          bIsOnBulkBuyMode;                                  // 0x1618(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1619[0x47];                                    // 0x1619(0x0047)(Fixing Struct Size After Last Property [ Dumper-8 ])
