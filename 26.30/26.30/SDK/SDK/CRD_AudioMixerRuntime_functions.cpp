...
// Function CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnAnyPropertyChanged
// (Final, Native, Private)

void ACreativeAudioMixerDevice::OnAnyPropertyChanged()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CreativeAudioMixerDevice", "OnAnyPropertyChanged");
...
// Function CRD_AudioMixerRuntime.CreativeAudioMixerDevice.OnRep_IsActiveForEveryone
// (Final, Native, Private)

void ACreativeAudioMixerDevice::OnRep_IsActiveForEveryone()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CreativeAudioMixerDevice", "OnRep_IsActiveForEveryone");
