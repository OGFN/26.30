...
void UChatContainer_C::BndEvt__ChatContainer_Button_Close_HackForBottomBar_K2Node_ComponentBoundEvent_3_CommonButtonBaseClicked__DelegateSignature(class UCommonButtonBase* Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ChatContainer_C", "BndEvt__ChatContainer_Button_Close_HackForBottomBar_K2Node_ComponentBoundEvent_3_CommonButtonBaseClicked__DelegateSignature");

	Params::ChatContainer_C_BndEvt__ChatContainer_Button_Close_HackForBottomBar_K2Node_ComponentBoundEvent_3_CommonButtonBaseClicked__DelegateSignature Parms{};
...
void UChatContainer_C::BndEvt__ChatContainer_Button_SendMessage_RiftStyle_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature(class UCommonButtonBase* Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ChatContainer_C", "BndEvt__ChatContainer_Button_SendMessage_RiftStyle_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature");

	Params::ChatContainer_C_BndEvt__ChatContainer_Button_SendMessage_RiftStyle_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature Parms{};
...
void UChatContainer_C::TransitionState(class UWidgetAnimation* TransitionAnimation, double TransitionTime, bool PlayForward)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ChatContainer_C", "TransitionState");
