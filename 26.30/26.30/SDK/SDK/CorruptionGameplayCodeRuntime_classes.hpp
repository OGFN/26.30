...
public:
	...
	struct FWarEffortMutatorMetadata              MeshNetworkMetadata;                               // 0x0498(0x0020)(BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	TArray<struct FWarEffortMutatorChoiceData>    WeaponChoices;                                     // 0x04B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPrimaryAssetId>                PreloadedItemList;                                 // 0x04C8(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	bool                                          bCanPreloadItems;                                  // 0x04D8(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4D9[0x1F];                                     // 0x04D9(0x001F)(Fixing Struct Size After Last Property [ Dumper-8 ])
