...
public:
	...
	TArray<struct FMutableRefSocket>              SocketArray;                                       // 0x0360(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UMutableMaskOutCache>    MaskOutCache;                                      // 0x0370(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<uint64, struct FMutableStreamableBlock>  HashToStreamableBlock;                             // 0x0390(0x0050)(NativeAccessSpecifierPublic)
	TArray<class FString>                         CustomizableObjectClassTags;                       // 0x03E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         PopulationClassTags;                               // 0x03F0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FString, struct FParameterTags>    CustomizableObjectParametersTags;                  // 0x0400(0x0050)(NativeAccessSpecifierPublic)
	TArray<class FName>                           BoneNames;                                         // 0x0450(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_460[0x10];                                     // 0x0460(0x0010)(Fixing Size After Last Property [ Dumper-8 ])
	class UMutableMaskOutCache*                   MaskOutCache_HardRef;                              // 0x0470(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGuid                                  CompilationGuid;                                   // 0x0478(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCustomizableObjectBulk*                BulkData;                                          // 0x0488(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                         Pad_88[0x68];                                      // 0x0088(0x0068)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_110[0x48];                                     // 0x0110(0x0048)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_288[0x48];                                     // 0x0288(0x0048)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	class UDefaultImageProvider*                  DefaultImageProvider;                              // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCustomizableInstanceLODManagementBase* DefaultInstanceLODManagement;                      // 0x0050(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCustomizableInstanceLODManagementBase* CurrentInstanceLODManagement;                      // 0x0058(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UTexture2D*>                     ProtectedCachedTextures;                           // 0x0060(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_70[0xF8];                                      // 0x0070(0x00F8)(Fixing Struct Size After Last Property [ Dumper-8 ])
