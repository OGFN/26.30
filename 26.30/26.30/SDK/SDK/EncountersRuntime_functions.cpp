...
void UStartLWMEncounterDelegateHandler::OnMobActorDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* HitComponent, class FName BoneName, const struct FVector& Momentum)
{
	static class UFunction* Func = nullptr;
	...
	Params::StartLWMEncounterDelegateHandler_OnMobActorDied Parms{};
...
void UStartLWMEncounterDelegateHandler::OnMobActorSpawn(class AActor* SpawnedActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::StartLWMEncounterDelegateHandler_OnMobActorSpawn Parms{};
...
void UStartLWMEncounterDelegateHandler::OnMobPawnEndPlay(class AActor* Mob, EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;
	...
	Params::StartLWMEncounterDelegateHandler_OnMobPawnEndPlay Parms{};
...
// Parameters:
// class APlayerController*                Contributor                                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UEncounterManagerComponent::AddExplicitContributor(class APlayerController* Contributor)
{
	static class UFunction* Func = nullptr;
...
void UEncounterManagerComponent::RemoveExplicitContributor(class APlayerController* Contributor)
{
	static class UFunction* Func = nullptr;
