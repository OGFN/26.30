...
{
public:
	struct FPlayerKeyMapping                      PlayerMapping;                                     // 0x0000(0x0088)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPlayerMappableKeyQueryOptions         Options;                                           // 0x0088(0x0028)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
{
public:
	struct FPlayerKeyMapping                      OutKeyMapping;                                     // 0x0000(0x0088)(Parm, OutParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMapPlayerKeyArgs                      InArgs;                                            // 0x0088(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
