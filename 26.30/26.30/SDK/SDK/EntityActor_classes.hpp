...
{
public:
	class FText                                   DisplayText;                                       // 0x0088(0x0018)(Edit, Net, RepNotify, NativeAccessSpecifierPrivate)
	float                                         ShadowVar_WorldSize;                               // 0x00A0(0x0004)(Edit, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FColor                                 ShadowVar_TextRenderColor;                         // 0x00A4(0x0004)(Edit, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bAddedTextRenderComponent;                         // 0x00A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
