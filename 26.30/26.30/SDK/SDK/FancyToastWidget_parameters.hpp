...
public:
	...
	struct FFortToastDisplayInfo                  K2Node_CustomEvent_DispalyInfo;                    // 0x0028(0x0058)()
	...
	struct FFortToastDisplayInfo                  K2Node_MakeStruct_FortToastDisplayInfo;            // 0x00B8(0x0058)()
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate_1;            // 0x0110(0x000C)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	int32                                         CallFunc_PointerEvent_GetUserIndex_ReturnValue;    // 0x0224(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FKey                                   CallFunc_PointerEvent_GetEffectingButton_ReturnValue; // 0x0228(0x0018)(HasGetValueTypeHash)
	bool                                          CallFunc_HasMouseCaptureByUser_ReturnValue;        // 0x0240(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_KeyKey_ReturnValue;            // 0x0241(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	struct FFortToastDisplayInfo                  DispalyInfo;                                       // 0x0000(0x0058)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
{
public:
	struct FFortToastDisplayInfo                  DisplayInfo;                                       // 0x0000(0x0058)(BlueprintVisible, BlueprintReadOnly, Parm)
	uint8                                         Temp_byte_Variable;                                // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
