...
public:
	...
	class ABP_FluidSim_FN_C*                      CallFunc_Array_Get_Item;                           // 0x01F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FFluidForceImpulse                     K2Node_MakeStruct_FluidForceImpulse;               // 0x0200(0x0058)(NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
