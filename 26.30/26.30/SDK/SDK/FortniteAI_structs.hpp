...
enum class EBehaviorTreeBranchesBitmask : uint8
{
	...
	CanUseZiplines                           = 18,
	Count                                    = 19,
	EBehaviorTreeBranchesBitmask_MAX         = 20,
};
...
public:
	...
	struct FGameplayTagQuery                      InjectionRequirements;                             // 0x0020(0x0048)(Edit, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   InjectedBehavior;                                  // 0x0068(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	class FText                                   UpgradeName;                                       // 0x0050(0x0018)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FFortInjectedBehaviorEntry>     InjectedBehaviors;                                 // 0x0028(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	class AFortPlayerController*                  TargetPlayer;                                      // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortAIEncounterInfo*                   EncounterInfo;                                     // 0x0058(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UFortAISpawnGroup*                      SpawnGroup;                                        // 0x0068(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class UFortAbilitySet*>                AbilitySetsToGrantOnSpawn;                         // 0x00A8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class UFortGameplayModifierItemDefinition*> ModifiersToApplyOnSpawn;                      // 0x00B8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	struct FFortAISpawnGroupUpgradeUIData         UpgradeUIData;                                     // 0x00C8(0x0068)(NativeAccessSpecifierPublic)
	TStructCycleFixup<struct FFortAIPawnLootDropData, 0x0010, 0x04> LootDropData;                    // 0x0130(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FFortAISpawnGroupUpgradeUIData         UpgradeUIData;                                     // 0x0058(0x0068)(NativeAccessSpecifierPublic)
	TArray<struct FFortAIPawnUpgradeData>         PawnUpgrades;                                      // 0x00C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UFortGameplayModifierItemDefinition*> ModifiersForAllPawns;                         // 0x00D0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class AFortAIPawn*>                    PawnList;                                          // 0x00E0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class AFortAIPawn*>                    LifespanExpiredList;                               // 0x00F0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
...
{
public:
	class UFortItemDefinition*                    ItemDefinition;                                    // 0x0000(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class UFortWeaponItemDefinition*              WeaponDefinitionCache;                             // 0x0030(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TStructCycleFixup<struct FFortWorldMarkerData, 0x0168, 0x08> MarkerData;                         // 0x0008(0x0168)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_170[0x18];                                     // 0x0170(0x0018)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	bool                                          bForceMissEnabled;                                 // 0x0100(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	struct FScalableFloat                         ForceMissEnabled;                                  // 0x02F8(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         ExtraClampingDistance;                             // 0x0320(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         PreventHeadshots;                                  // 0x0348(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         WeaponSpreadContributionToClampCurve;              // 0x0370(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         KillingBlowGracePeriodAtMinRange;                  // 0x0398(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         KillingBlowGracePeriodAtMaxRange;                  // 0x03C0(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         ExtraHitOddsCurve;                                 // 0x03E8(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
};
...
public:
	...
	struct FAimingCircleSettings                  AimingCircleSettingsOverride;                      // 0x0350(0x0410)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FWeaponAccuracy                        WeaponAccuracy;                                    // 0x0020(0x0760)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FWeaponAccuracy                        WeaponAccuracy;                                    // 0x0020(0x0760)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TArray<struct FWeaponAccuracyCategorySpecialization> Specializations;                            // 0x0780(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FRangedWeaponSkill                     WeaponSkill;                                       // 0x0020(0x0160)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FRangedWeaponSkill                     WeaponSkill;                                       // 0x0020(0x0160)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TArray<struct FRangedWeaponSkillCategorySpecialization> Specializations;                         // 0x0180(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
...
public:
	...
	TArray<struct FDigestedFiringPattern>         TargetInAirFiringPatterns;                         // 0x0020(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	TArray<struct FDigestedFiringPattern>         FiringPatterns;                                    // 0x0030(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
};
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Transient, NativeAccessSpecifierPrivate)
	struct FDigestedRangedWeaponSkill             WeaponSkill;                                       // 0x0020(0x0040)(Transient, NativeAccessSpecifierPrivate)
};
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Transient, NativeAccessSpecifierPrivate)
	struct FDigestedRangedWeaponSkill             WeaponSkill;                                       // 0x0020(0x0040)(Transient, NativeAccessSpecifierPrivate)
	TArray<struct FDigestedRangedWeaponSkillCategorySpecialization> Specializations;                 // 0x0060(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
};
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-8 ])
	class UFortAthenaAIBotEvaluator_Movement*     MovementEval;                                      // 0x0008(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TStructCycleFixup<struct FFortAthenaLoadout, 0x0260, 0x08> CosmeticLoadout;                      // 0x0000(0x0260)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         Weight;                                            // 0x0260(0x0028)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         bShouldGrantLootOnSpawn : 1;                       // 0x0048(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_38[0x108];                                     // 0x0038(0x0108)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
