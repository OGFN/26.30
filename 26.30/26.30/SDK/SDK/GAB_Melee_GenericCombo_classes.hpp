...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAB_Melee_GenericCombo_C;           // 0x0B60(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	double                                        OriginalMontagePlayRate;                           // 0x0B68(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
