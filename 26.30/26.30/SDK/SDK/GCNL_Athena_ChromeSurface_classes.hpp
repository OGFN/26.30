...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GCNL_Athena_ChromeSurface_C;        // 0x09A8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class AFortPlayerPawn*                        LocalTarget;                                       // 0x09B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
