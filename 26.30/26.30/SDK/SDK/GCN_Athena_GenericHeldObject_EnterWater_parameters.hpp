...
struct GCN_Athena_GenericHeldObject_EnterWater_C_OnBurst final
{
public:
	...
	TScriptInterface<class IAudioParameterControllerInterface> CallFunc_SetIntParameter_self_CastInput; // 0x01E8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
