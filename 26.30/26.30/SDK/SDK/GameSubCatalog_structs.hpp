...
{
public:
	class FString                                 Playlist;                                          // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 IslandId;                                          // 0x0040(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 IslandTitle;                                       // 0x0050(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FCatalogPurchaseAdditionalData         AdditionalData;                                    // 0x0070(0x0060)(NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FCatalogPurchaseAdditionalData         AdditionalData;                                    // 0x0050(0x0060)(NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	class FString                                 GameContext;                                       // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FCatalogPurchaseAdditionalData         AdditionalData;                                    // 0x0040(0x0060)(NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FItemQuantity>                  ItemGrants;                                        // 0x0200(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FCatalogOfferRequirement>       Requirements;                                      // 0x0210(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<class FString>                         DenyItemTemplateIds;                               // 0x0250(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
};
