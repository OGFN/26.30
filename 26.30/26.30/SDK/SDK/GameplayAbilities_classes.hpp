...
public:
	...
	uint8                                         Pad_2F0[0x20];                                     // 0x02F0(0x0020)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_338[0x60];                                     // 0x0338(0x0060)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_39C[0x14];                                     // 0x039C(0x0014)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	TArray<class UGameplayEffect*>                GameplayEffectsWhileAnimating;                     // 0x03D8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	...
	ERootMotionMoveToActorTargetOffsetType        OffsetAlignment;                                   // 0x0120(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	EMovementMode                                 NewMovementMode;                                   // 0x012A(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UCurveVector*                           PathOffsetCurve;                                   // 0x0130(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCurveFloat*                            TimeMappingCurve;                                  // 0x0138(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCurveFloat*                            TargetLerpSpeedHorizontalCurve;                    // 0x0140(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCurveFloat*                            TargetLerpSpeedVerticalCurve;                      // 0x0148(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	class UMovementComponent*                     CachedMovementComponent;                           // 0x0088(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_13C[0x1AC];                                    // 0x013C(0x01AC)(Fixing Size After Last Property [ Dumper-8 ])
	...
	TArray<class AGameplayAbilityTargetActor*>    SpawnedTargetActors;                               // 0x0398(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_3A8[0x28];                                     // 0x03A8(0x0028)(Fixing Size After Last Property [ Dumper-8 ])
	class AActor*                                 OwnerActor;                                        // 0x03D0(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class AActor*                                 AvatarActor;                                       // 0x03D8(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3E0[0x10];                                     // 0x03E0(0x0010)(Fixing Size After Last Property [ Dumper-8 ])
	struct FGameplayAbilitySpecContainer          ActivatableAbilities;                              // 0x03F0(0x0120)(BlueprintVisible, BlueprintReadOnly, Net, Transient, RepNotify, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_510[0x30];                                     // 0x0510(0x0030)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<class UGameplayAbility*>               AllReplicatedInstancedAbilities;                   // 0x0540(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_550[0x230];                                    // 0x0550(0x0230)(Fixing Size After Last Property [ Dumper-8 ])
	struct FGameplayAbilityRepAnimMontage         RepAnimMontageInfo;                                // 0x0780(0x0038)(Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	struct FGameplayAbilityLocalAnimMontage       LocalAnimMontageInfo;                              // 0x07C0(0x0030)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_7F0[0xA0];                                     // 0x07F0(0x00A0)(Fixing Size After Last Property [ Dumper-8 ])
	struct FActiveGameplayEffectsContainer        ActiveGameplayEffects;                             // 0x0890(0x02F8)(Net, Protected, NativeAccessSpecifierProtected)
	struct FActiveGameplayCueContainer            ActiveGameplayCues;                                // 0x0B88(0x0128)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FActiveGameplayCueContainer            MinimalReplicationGameplayCues;                    // 0x0CB0(0x0128)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_DD8[0x128];                                    // 0x0DD8(0x0128)(Fixing Size After Last Property [ Dumper-8 ])
	TArray<uint8>                                 BlockedAbilityBindings;                            // 0x0F00(0x0010)(Net, ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_F10[0x128];                                    // 0x0F10(0x0128)(Fixing Size After Last Property [ Dumper-8 ])
	struct FMinimalReplicationTagCountMap         MinimalReplicationTags;                            // 0x1038(0x0060)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UAttributeSet*>                  SpawnedAttributes;                                 // 0x1098(0x0010)(ExportObject, Net, ZeroConstructor, Transient, RepNotify, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_10A8[0x10];                                    // 0x10A8(0x0010)(Fixing Size After Last Property [ Dumper-8 ])
	struct FMinimalReplicationTagCountMap         ReplicatedLooseTags;                               // 0x10B8(0x0060)(Net, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1118[0x8];                                     // 0x1118(0x0008)(Fixing Size After Last Property [ Dumper-8 ])
	struct FReplicatedPredictionKeyMap            ReplicatedPredictionKeyMap;                        // 0x1120(0x0118)(Net, Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_1238[0x10];                                    // 0x1238(0x0010)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_1D8[0x40];                                     // 0x01D8(0x0040)(Fixing Struct Size After Last Property [ Dumper-8 ])
