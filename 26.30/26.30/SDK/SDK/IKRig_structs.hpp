...
public:
	...
	struct FTargetChainSpeedPlantSettings         SpeedPlanting;                                     // 0x0090(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   DirectionChain;                                    // 0x000C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WarpForwards;                                      // 0x0010(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SidewaysOffset;                                    // 0x0014(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WarpSplay;                                         // 0x0018(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FRetargetGlobalSettings                GlobalSettings;                                    // 0x00DC(0x001C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         Pad_118[0xC0];                                     // 0x0118(0x00C0)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_1DC[0x4];                                      // 0x01DC(0x0004)(Fixing Struct Size After Last Property [ Dumper-8 ])
};

// ScriptStruct IKRig.AnimNode_RetargetPoseFromMesh
// 0x01B8 (0x01C8 - 0x0010)
...
public:
	...
	struct FRetargetProfile                       CustomRetargetProfile;                             // 0x0028(0x00F8)(Edit, BlueprintVisible, Transient, NativeAccessSpecifierPublic)
	bool                                          bSuppressWarnings;                                 // 0x0120(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCopyCurves;                                       // 0x0121(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_122[0x6];                                      // 0x0122(0x0006)(Fixing Size After Last Property [ Dumper-8 ])
	class UIKRetargetProcessor*                   Processor;                                         // 0x0128(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_130[0x98];                                     // 0x0130(0x0098)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
