...
public:
	...
	TSoftClassPtr<class UClass>                   PipelineConfigurationDialogClass;                  // 0x0058(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowPipelineStacksConfigurationDialog;            // 0x0078(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TMap<EInterchangeTranslatorAssetType, bool>   ShowPipelineStacksConfigurationDialogOverride;     // 0x00D0(0x0050)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	TDelegate<void(class UObject* Object)>        OnAssetDone;                                       // 0x0020(0x000C)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x14];                                      // 0x002C(0x0014)(Fixing Size After Last Property [ Dumper-8 ])
	TDelegate<void(const TArray<class UObject*>& Objects)> OnAssetsImportDone;                       // 0x0040(0x000C)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x14];                                      // 0x004C(0x0014)(Fixing Size After Last Property [ Dumper-8 ])
	TDelegate<void(class UObject* Object)>        OnSceneObjectDone;                                 // 0x0060(0x000C)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C[0x14];                                      // 0x006C(0x0014)(Fixing Size After Last Property [ Dumper-8 ])
	TDelegate<void(const TArray<class UObject*>& Objects)> OnSceneImportDone;                        // 0x0080(0x000C)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8C[0x14];                                      // 0x008C(0x0014)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
