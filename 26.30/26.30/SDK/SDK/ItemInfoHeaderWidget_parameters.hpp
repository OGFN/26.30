...
public:
	...
	class FText                                   CallFunc_GetItemTypeName_ReturnValue;              // 0x0010(0x0018)()
	EFortItemType                                 CallFunc_GetItemType_ReturnValue;                  // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	class FText                                   CallFunc_GetShortDescription_ReturnValue;          // 0x0030(0x0018)()
	...
	struct FFortColorPalette                      CallFunc_GetRarityOrSeriesColors_ReturnValue;      // 0x004C(0x0050)(NoDestructor)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	class FText                                   CallFunc_GetRichDescription_ReturnValue;           // 0x00A0(0x0018)()
...
struct ItemInfoHeaderWidget_C_UpdateRichDescSize final
{
public:
	TArray<class FText>                           RichDescriptions;                                  // 0x0000(0x0010)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	...
	class UItemInfoHeaderDescription_C*           CallFunc_Create_ReturnValue;                       // 0x0048(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
