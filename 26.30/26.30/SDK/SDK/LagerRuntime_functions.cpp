...
void UFortAthenaLivingWorldManager::RegisterTagDensityReservoir(class AActor* ActorDensityReservoir, const TArray<struct FFortAthenaLivingWorldEventTagDensityRegistration>& TagsDensity)
{
	static class UFunction* Func = nullptr;
