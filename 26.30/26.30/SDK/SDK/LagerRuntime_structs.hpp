...
public:
	...
	struct FFortAthenaLivingWorldEventDespawnCondition DespawnCondition;                             // 0x0148(0x0018)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPrivate)
	TArray<struct FFortAthenaLivingWorldDespawnCondition> DespawnConditions;                         // 0x0160(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FGameplayTagContainer                  RequirePlaylistTags;                               // 0x0170(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FLivingWorldCalendarEventConditions    CalendarEventConditions;                           // 0x0190(0x0018)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FScalableFloat                         MaxSpawnCountPerEventGeneration;                   // 0x0048(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
...
{
public:
	uint8                                         Pad_C0[0x98];                                      // 0x00C0(0x0098)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
struct alignas(0x08) FFortAthenaLivingWorldPointProviderSelector final
{
public:
