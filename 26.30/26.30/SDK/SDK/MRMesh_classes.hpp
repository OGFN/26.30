...
{
public:
	TMulticastInlineDelegate<void(int32 Index, const TArray<struct FVector>& Vertices, const TArray<int32>& Triangles, const TArray<struct FVector>& Normals, const TArray<float>& Confidence)> OnMeshTrackerUpdated; // 0x02A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_2F8[0x18];                                     // 0x02F8(0x0018)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	struct FBodyInstance                          BodyInstance;                                      // 0x0038(0x0188)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C0[0x68];                                     // 0x01C0(0x0068)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_582[0x1];                                      // 0x0582(0x0001)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_584[0x44];                                     // 0x0584(0x0044)(Fixing Size After Last Property [ Dumper-8 ])
