...
public:
	...
	uint8                                         Pad_5C[0x5C];                                      // 0x005C(0x005C)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	bool                                          bAutoRegisterWithObserverRegistry;                 // 0x00B8(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_B9[0x7];                                       // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	class UScriptStruct*                          ObservedType;                                      // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_CC[0x24];                                      // 0x00CC(0x0024)(Fixing Struct Size After Last Property [ Dumper-8 ])
