...
public:
	...
	struct FAnimNode_RigidBody                    AnimGraphNode_RigidBody;                           // 0x0D40(0x0950)()
	struct FAnimNode_ModifyBone                   AnimGraphNode_ModifyBone;                          // 0x1690(0x0128)()
	struct FRotator                               gear_rot;                                          // 0x17B8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	class USkeletalMeshComponent*                 skel_mesh;                                         // 0x17D0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
