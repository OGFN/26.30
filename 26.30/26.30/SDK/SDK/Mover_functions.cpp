...
void UKinematicMoverComponent::OnHistoryTrackingRollback(const struct FMoverTimeStep& NewTimeStep, const struct FMoverTimeStep& InvalidatedTimeStep)
{
	static class UFunction* Func = nullptr;
	...
	Params::KinematicMoverComponent_OnHistoryTrackingRollback Parms{};
...
void UKinematicMoverComponent::SetHistoryTracking(float SecondsToTrack, float SamplesPerSecond)
{
	...
	Params::KinematicMoverComponent_SetHistoryTracking Parms{};
...
TArray<struct FTrajectorySampleInfo> UKinematicMoverComponent::GetFutureTrajectory(float FutureSeconds, float SamplesPerSecond) const
{
	static class UFunction* Func = nullptr;
	...
	Params::KinematicMoverComponent_GetFutureTrajectory Parms{};
...
TArray<struct FTrajectorySampleInfo> UKinematicMoverComponent::GetPastTrajectory() const
{
	static class UFunction* Func = nullptr;
	...
	Params::KinematicMoverComponent_GetPastTrajectory Parms{};
...
float UMovementUtils::TryMoveToFallAlongSurface(class USceneComponent* UpdatedComponent, class UPrimitiveComponent* UpdatedPrimitive, const struct FVector& Delta, float PctOfDeltaToMove, const struct FQuat& Rotation, const struct FVector& Normal, struct FHitResult* Hit, bool bHandleImpact, float FloorSweepDistance, float MaxWalkSlopeCosine, struct FFloorCheckResult* OutFloorResult, struct FMovementRecord* MoveRecord)
{
	static class UFunction* Func = nullptr;
...
float UMovementUtils::TryWalkToSlideAlongSurface(class USceneComponent* UpdatedComponent, class UPrimitiveComponent* UpdatedPrimitive, const struct FVector& Delta, float PctOfDeltaToMove, const struct FQuat& Rotation, const struct FVector& Normal, struct FHitResult* Hit, bool bHandleImpact, struct FMovementRecord* MoveRecord, float MaxWalkSlopeCosine)
{
	static class UFunction* Func = nullptr;
