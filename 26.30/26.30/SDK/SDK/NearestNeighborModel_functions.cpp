...
// const TArray<int32>&                    Shape                                                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
void UNearestNeighborNetworkLayer::AddParameter(const TArray<float>& Values, const TArray<int32>& Shape)
{
	...
	Params::NearestNeighborNetworkLayer_AddParameter Parms{};
...
// Parameters:
// const int32                             LayerType                                              (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UNearestNeighborNetworkLayer* UNearestNeighborOptimizedNetwork::AddLayer(const int32 LayerType)
{
	static class UFunction* Func = nullptr;
	...
	Params::NearestNeighborOptimizedNetwork_AddLayer Parms{};
