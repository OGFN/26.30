...
public:
	...
	class UEpicCMSImage*                          CMSImage;                                          // 0x00E0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPictureInPictureSourceActionData*      ActionData;                                        // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSet<class FString>                           PlatformDenylist;                                  // 0x00F0(0x0050)(BlueprintVisible, NativeAccessSpecifierPublic)
	TSet<class FString>                           GameplayTagDenylist;                               // 0x0140(0x0050)(BlueprintVisible, NativeAccessSpecifierPublic)
	TSet<class FString>                           GameplayTagAllowlist;                              // 0x0190(0x0050)(BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bManual;                                           // 0x01E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
