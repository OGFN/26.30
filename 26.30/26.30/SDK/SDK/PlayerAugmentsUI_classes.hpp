...
{
public:
	class UFortItemDefinition*                    RerollCurrency;                                    // 0x0120(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	class UCommonButtonBase*                      Button_PlayerAugmentTimer;                         // 0x0358(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<class UFortPlayerAugmentItemDefinition*> AvailableAugmentItemDefinitions;                 // 0x0328(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	struct FFortTabButtonLabelInfo                TabButtonLabelInfo;                                // 0x0460(0x00F0)(Edit, NativeAccessSpecifierPrivate)
