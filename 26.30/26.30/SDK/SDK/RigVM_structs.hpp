...
public:
	...
	uint8                                         Pad_C[0x104];                                      // 0x000C(0x0104)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_114[0x5C];                                     // 0x0114(0x005C)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_178[0x40];                                     // 0x0178(0x0040)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	class FText                                   ToolTip;                                           // 0x0058(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	class FString                                 category;                                          // 0x0070(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Keywords;                                          // 0x0080(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FRigVMGraphFunctionArgument>    Arguments;                                         // 0x0090(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TMap<struct FRigVMGraphFunctionIdentifier, uint32> Dependencies;                                 // 0x00A0(0x0050)(NativeAccessSpecifierPublic)
	TArray<struct FRigVMExternalVariable>         ExternalVariables;                                 // 0x00F0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	bool                                          bEncounteredSurpressedErrors;                      // 0x01D4(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D5[0x53];                                     // 0x01D5(0x0053)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
{
public:
	struct FRigVMGraphFunctionHeader              Header;                                            // 0x0000(0x0100)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigVMFunctionCompilationData          CompilationData;                                   // 0x0100(0x0228)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SerializedCollapsedNode;                           // 0x0328(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
