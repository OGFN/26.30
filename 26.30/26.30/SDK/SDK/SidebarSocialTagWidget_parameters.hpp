...
public:
	...
	bool                                          K2Node_Event_bHighlighted;                         // 0x0023(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	class UCommonButtonLegacy*                    CallFunc_FindParentWidgetOfType_ReturnValue;       // 0x0028(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           K2Node_Select_Default_3;                           // 0x0068(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FSidebarSocialTagCategoryStructure     CallFunc_Get_Sidebar_Social_Tag_Category_Structure_SidebarSocialTagCategoryStructure_1; // 0x00B8(0x0070)(HasGetValueTypeHash)
	TSoftObjectPtr<class UMaterialInstance>       CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue; // 0x0128(0x0020)(UObjectWrapper, HasGetValueTypeHash)
