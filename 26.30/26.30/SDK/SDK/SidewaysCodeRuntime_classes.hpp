...
{
public:
	uint8                                         Pad_F8[0xA8];                                      // 0x00F8(0x00A8)(Fixing Size After Last Property [ Dumper-8 ])
	class UAthenaAIServiceLoot*                   CachedAIServiceLoot;                               // 0x01A0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
