...
public:
	...
	struct FGameplayTag                           tag;                                               // 0x001C(0x0004)(BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FCollisionProfileName                  CollisionProfile;                                  // 0x0018(0x0004)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bTraceComplex;                                     // 0x001C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FSmartObjectTraceParams                GroundTraceParameters;                             // 0x0020(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FSmartObjectTraceParams                TransitionTraceParameters;                         // 0x0040(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
	bool                                          bUseNavigationCapsuleSize;                         // 0x0060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_61[0x3];                                       // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-8 ])
	struct FSmartObjectUserCapsuleParams          UserCapsule;                                       // 0x0064(0x000C)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
};
...
public:
	...
	struct FVector3f                              Offset;                                            // 0x00A8(0x000C)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator3f                             Rotation;                                          // 0x00B4(0x000C)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FInstancedStruct>               Data;                                              // 0x00C0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<class USmartObjectBehaviorDefinition*> BehaviorDefinitions;                               // 0x00D0(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
};
...
{
public:
	TSoftClassPtr<class UClass>                   ObjectActorClass;                                  // 0x0000(0x0020)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        ObjectMeshPath;                                    // 0x0020(0x0018)(Edit, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   UserActorClass;                                    // 0x0038(0x0020)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   UserValidationFilterClass;                         // 0x0058(0x0020)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                         Pad_1[0xB];                                        // 0x0001(0x000B)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
{
public:
	struct FSmartObjectHandle                     SmartObjectHandle;                                 // 0x0000(0x0008)(Edit, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSmartObjectSlotHandle                 SlotHandle;                                        // 0x0008(0x0010)(Edit, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                         Pad_0[0x70];                                       // 0x0000(0x0070)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_50[0xB0];                                      // 0x0050(0x00B0)(Fixing Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_89[0x67];                                      // 0x0089(0x0067)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
struct alignas(0x08) FSmartObjectSlotEntranceLocationRequest final
{
public:
...
public:
	...
	struct FGameplayTag                           tag;                                               // 0x0038(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
