...
public:
	...
	class ULeavePlatformPartyButton_C*            K2Node_DynamicCast_AsLeave_Platform_Party_Button;  // 0x0038(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
