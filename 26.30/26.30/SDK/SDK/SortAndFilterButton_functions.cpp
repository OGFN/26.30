...
void USortAndFilterButton_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SortAndFilterButton_C", "Tick");

	Params::SortAndFilterButton_C_Tick Parms{};
