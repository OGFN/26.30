...
public:
	...
	TArray<class USoundBase*>                     LoadedSoundObjects;                                // 0x0140(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<TSoftObjectPtr<class USoundBase>>      Assets;                                            // 0x0150(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	TMulticastInlineDelegate<void(const struct FSoundLibraryPlayResult& Results, const class USoundLibraryContext* Context)> OnSoundLibraryPlayEvent; // 0x00D0(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_E0[0x50];                                      // 0x00E0(0x0050)(Fixing Size After Last Property [ Dumper-8 ])
	class USoundLibraryContext*                   Context;                                           // 0x0130(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
