...
public:
	...
	void OnShowActivityData(const class FText& ActivityDisplayName, const class FText& ActivityDescription, const class FString& CreatorName, const class FText& LinkCode);
...
{
public:
	uint8                                         Pad_1490[0x20];                                    // 0x1490(0x0020)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_BD8[0x8];                                      // 0x0BD8(0x0008)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	class FText                                   WeaponLabelText;                                   // 0x0300(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   GameModeLabelText;                                 // 0x0318(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	...
	TArray<class UFortCreativeDiscoveryActivityProvider*> CachedDataProviders;                       // 0x0338(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)

public:
	void OnChangeLoading(bool bIsLoading);
...
{
public:
	class UFortContentManagementList*             ContentManagementList;                             // 0x0548(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
