...
// Function SqueegeeUI.FortContentGateDetailsWidget.OnShowWeaponDescription
// (Event, Protected, BlueprintEvent)

void UFortContentGateDetailsWidget::OnShowWeaponDescription()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortContentGateDetailsWidget", "OnShowWeaponDescription");
...
void UFortContentManagementDetails::OnShowActivityData(const class FText& ActivityDisplayName, const class FText& ActivityDescription, const class FString& CreatorName, const class FText& LinkCode)
{
	static class UFunction* Func = nullptr;
...
// Function SqueegeeUI.FortContentManagementButton.OnShowWeaponManagement
// (Event, Protected, BlueprintEvent)

void UFortContentManagementButton::OnShowWeaponManagement()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortContentManagementButton", "OnShowWeaponManagement");
...
// Function SqueegeeUI.FortContentManagementList.OnChangeLoading
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bIsLoading                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortContentManagementList::OnChangeLoading(bool bIsLoading)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortContentManagementList", "OnChangeLoading");

	Params::FortContentManagementList_OnChangeLoading Parms{};
