...
public:
	...
	uint8                                         Pad_58[0x198];                                     // 0x0058(0x0198)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	TWeakObjectPtr<class UStyleRuleTree>          StyleRuleTree;                                     // 0x0028(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TMap<TWeakObjectPtr<class UObject>, class UStyleThemeConfig*> ThemeConfigSourceMap;              // 0x0030(0x0050)(Edit, EditConst, UObjectWrapper, NativeAccessSpecifierPrivate)
	TSet<class FName>                             ActiveThemeNames;                                  // 0x0080(0x0050)(Edit, EditConst, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<TSubclassOf<class UWidget>>            AllowedWidgetClasses;                              // 0x0028(0x0010)(Edit, ZeroConstructor, Config, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<struct FWidgetTypeEntry>               WidgetTypes;                                       // 0x0038(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPrivate)
	TMap<TSubclassOf<class UWidget>, struct FGameplayTag> WidgetTypeMap;                             // 0x0048(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UStyleThemeConfig>       StyleThemeConfig;                                  // 0x0098(0x0020)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	class UStyleTagFinder*                        EditorStyleTagFinder;                              // 0x0030(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UStyleRuleTree*                         StyleRuleTree;                                     // 0x0038(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UStyleAnimationProvider*                StyleAnimationProvider;                            // 0x0040(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UStyleProvider*                         StyleProvider;                                     // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UStyleThemeProvider*                    StyleThemeProvider;                                // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UStyleTagFinder*                        StyleTagFinder;                                    // 0x0058(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
