...
public:
	...
	struct FCameraFocusSettings                   FocusSettings;                                     // 0x0750(0x0058)(NativeAccessSpecifierPublic)
	float                                         CurrentFocalLength;                                // 0x07A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurrentAperture;                                   // 0x07AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CurrentFocusDistance;                              // 0x07B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7B4[0x7C];                                     // 0x07B4(0x007C)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	uint8                                         Pad_28[0x270];                                     // 0x0028(0x0270)(Fixing Size After Last Property [ Dumper-8 ])
	...
	uint8                                         Pad_330[0x68];                                     // 0x0330(0x0068)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	struct FSoftObjectPath                        TemplateSequence;                                  // 0x02C0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTemplateSequenceBindingOverrideData   BindingOverride;                                   // 0x02D8(0x000C)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
