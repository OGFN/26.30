...
{
public:
	class UFortDagwoodVehicleConfigs*             FortDagwoodVehicleConfigs;                         // 0x0188(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDagwoodRuntimeModifiers               DagwoodRuntimeModifiedProperties;                  // 0x0190(0x0070)(NativeAccessSpecifierPublic)
	uint8                                         Pad_200[0x48];                                     // 0x0200(0x0048)(Fixing Struct Size After Last Property [ Dumper-8 ])
};
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	struct FFortDagwoodCmd                        InputCmd;                                          // 0x0008(0x0030)(NoDestructor, NativeAccessSpecifierPublic)
	struct FDagwoodInPersistent                   GT_State;                                          // 0x0038(0x0248)(NativeAccessSpecifierPublic)
	struct FDagwoodState_PT                       PT_State;                                          // 0x0280(0x01B8)(NativeAccessSpecifierPublic)
	class APlayerController*                      PC;                                                // 0x0438(0x0008)(ZeroConstructor, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
